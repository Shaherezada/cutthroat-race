...
class Board:
    ...
    def _fill_map(self):
        ...
        self.add_cell(10, CellType.PORTAL, "Синий портал #1", 23)
        ...
        self.add_cell(17, CellType.PORTAL, "Розовый портал #1", 28)
        ...
        self.add_cell(23, CellType.PORTAL, "Синий портал #2", 10)
        ...
        self.add_cell(28, CellType.PORTAL, "Розовый портал #2", 17)
        ...
        self.add_cell(36, CellType.PORTAL, "Жёлтый портал #1", 47)
        ...
        self.add_cell(47, CellType.PORTAL, "Жёлтый портал #2", 36)
        ...
        self.add_cell(52, CellType.PORTAL, "Зелёный портал #1", 64)
        ...
        self.add_cell(64, CellType.PORTAL, "Зелёный портал #2", 52)
